        ...
        switch(action){
          case "cmap":
            ...
            Modal.confirm({
              ...
              onOk: () => {
                return http.delete('/api/app/deploy/cmapop/', {params: {id: info.id, env: 2,tag:"feiyanuos"}})
                  .then(() => {
          ...
          case "pvc":
            ...
            Modal.confirm({
              ...
              onOk: () => {
                return http.delete('/api/app/deploy/pvcop/', {params: {id: info.id, env: 2,tag:"feiyanuos"}})
                  .then(() => {
                    message.success('删除成功');
                    store.fetchRecords()
                  })
